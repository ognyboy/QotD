...
{
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"http://199.180.255.173/index.php/mobile/getAttempted/%d/%@", [self.userModel getUserID], [self.userModel.listOfSections objectAtIndex:0]]];
